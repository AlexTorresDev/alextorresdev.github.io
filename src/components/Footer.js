            ...
            <div className="contact">
                <Typography variant="body1">
                    Puedes contactarme en: <b><a
                        href="mailto:contacto@alextorressk.com">alextorressk@gmail.com</a></b> o visitar mis redes
                    sociales.
                </Typography>
                <div className="social">
                    <a className="item" href="https://twitter.com/AlexTorresSk"><Twitter /></a>
                    <a className="item" href="https://github.com/AlexTorresSk"><GitHub /></a>
                </div>
            </div>
